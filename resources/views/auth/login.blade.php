                ...
                <div class="h-100 no-gutters row">
                            ...
                            <div class="slick-slider">
                                <div>
                                        <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-royal" tabindex="-1">
                                            <div class="slide-img-bg" style="background-image: url('{{asset('images/dashboard/logo.png')}}'); background-repeat:no-repeat; background-size:auto !important;"></div>
                                ...
                                {{-- <div>
                                    ...
                                    <div class="slide-img-bg" style="background-image: url('{{asset('images/dashboard/logo.png')}}');"></div>
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h4 class="mb-0">
                                <span class="d-block">{{config('staticTexts.welcome_title')}}</span>
                                <span>{{config('staticTexts.welcome_subtitle')}}</span></h4>
